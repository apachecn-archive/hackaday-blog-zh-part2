...
> 原文:[https://hack aday . com/2014/02/24/guest-post-try-radar-for-your ' s next-project/](https://hackaday.com/2014/02/24/guest-post-try-radar-for-your-next-project/)
...
![radar_simple_example](../Images/03bd4f1e104f3d54f41c79be1ec789c2.png "How radar works.")
...
[![basic_pulsed_radar](../Images/366e67855f3bda509f9e9e4411efdfbd.png)](http://hackaday.com/wp-content/uploads/2014/02/basic_pulsed_radar.png)
...
[![coherent_CW_Doppler_radar](../Images/fe1ea689ed3e68da00c7601b5a8aaa7c.png "CW Doppler Radar block diagram.")](http://hackaday.com/wp-content/uploads/2014/02/coherent_cw_doppler_radar.png)
...
[![Chinese CW doppler radar](../Images/0025187f796c0f2039207a2400e50eb1.png)](http://hackaday.com/wp-content/uploads/2014/02/chinese-cw-doppler-radar.png)
...
[![basic_impulse_radar](../Images/d4802ae8578ce0aa9e0c6de3065381f6.png)](http://hackaday.com/wp-content/uploads/2014/02/basic_impulse_radar.png)
...
![NVA6100_Match](../Images/3cc4947799ebf4339f4e897fcc209cb7.png "Novelda impulse radar.")
...
[![coherent_FMCW_radar](../Images/3d0a033a40a59daec152a96e8b8136b8.png)](http://hackaday.com/wp-content/uploads/2014/02/coherent_fmcw_radar.png)
...
对于 FMCW 雷达，CW 振荡器通过线性斜坡进行频率调制。换句话说，CW 振荡器从一个频率开始，经过一段相对较长的时间(0.5-10 uS)斜升至一秒。该波形从发射天线向目标场景辐射。这个波形的一部分被馈送到接收机混频器。从目标散射出来的信号被 LNA 放大，并馈入接收混频器，在那里与发射波形混合。混频产物产生与范围成比例的低频(KHz 范围)拍音。拍音频率越高，目标越远。如果测量多个目标，则预期会看到多个彼此叠加的拍音。要测量到目标的距离，请使用低带宽数字化仪进行数字化，小心地使数字化仪的触发与上升斜坡的开始同步。利用每个上升斜坡的数字化数据，应用 DFT。这产生了从发射机到目标并返回到接收机的往返时间的时域表示。
 ...
 [![KCL-1](../Images/b151ac3f4d24cbb26bbbbd8b2491e6c4.png "RF Beam Microwave GmbH K-LC1 FMCW radar.")](https://hackaday.com/2014/02/24/guest-post-try-radar-for-your-next-project/kcl-1/) The RF Beam Microwave GmbH K-LC1 FMCW radar, a 24 GHz FMCW radar for < $10 (in quantity). [![coffe can radar photo res-ll-003iap11](../Images/33f8e029d17484147edd2b0e1e09f670.png "MIT Coffee Can Radar")](https://hackaday.com/2014/02/24/guest-post-try-radar-for-your-next-project/coffe-can-radar-photo-res-ll-003iap11/) Learn by doing, take the MIT Coffee Can Radar Course, open to everyone through either MIT Professional Education or take it online for free at MIT Opencourseware. [![QDM radar kit](../Images/69e0ccdd47374af98405c49e3f148400.png "Quonset Microwave Coffee Can Radar Kit")](https://hackaday.com/2014/02/24/guest-post-try-radar-for-your-next-project/qdm-radar-kit/) The first fully manufactured Coffee Can Radar Kit is now available from Quonset Microwave in Warwick RI. [![k650q-Arduino+Radar_teaser](../Images/7f429aa3758ec0b0a8660c0aa7fab7cd.png "The Radar Arduino Shield.")](https://hackaday.com/2014/02/24/guest-post-try-radar-for-your-next-project/k650q-arduinoradar_teaser/) Coming soon, the radar Arduino shield.
