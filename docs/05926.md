...
> 原文:[https://hack aday . com/2014/04/28/robot artist-draws-what-it-sees/](https://hackaday.com/2014/04/28/robotartist-draws-what-it-sees/)

![roboartist-vector-image-machine](../Images/938102d832a9981dc1a3540409bbee26.png)
...
[![robo-artist-underlighting](../Images/804af8d4d3b8dc7e695c7e013f68a5c3.png)](http://hackaday.com/wp-content/uploads/2014/04/robo-artist-underlighting.png) 除了你能看到的丙烯酸绘图表面周围的发光二极管，下面还有一排排 RGB 条纹。该软件运行一个过滤器的照明不足，以恭维在纸上的线条。这就是为什么有一个紫色的色调向一侧逐渐消失的原因。
