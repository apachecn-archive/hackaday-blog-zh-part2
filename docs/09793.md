...
> 原文:[https://hack aday . com/2015/08/10/hacking-the-Amazon-dash-button-to-record-what-you-want/](https://hackaday.com/2015/08/10/hacking-the-amazon-dash-button-to-record-whatever-you-want/)
...
这其实很简单。购买破折号按钮，用亚马逊做设置…但是不要做最后一步:选择你想要订购的产品。如果你不选择任何东西，你就不会点任何东西…
 ...
 ![dash banner](../Images/3e8ccc33299dedd3b620248ffd6cf782.png)dash 按钮的妙处在于它是为省电而设计的，也就是说它只有在你按下按钮时才会自动开启。
...
[https://www.youtube.com/embed/qKSqV44RZ3E?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent](https://www.youtube.com/embed/qKSqV44RZ3E?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent)T2】
