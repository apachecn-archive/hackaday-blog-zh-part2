...
> 原文:[https://hack aday . com/2015/04/12/documentating-poor-documentated-led-strips/](https://hackaday.com/2015/04/12/documenting-poorly-documented-led-strips/)
...
![You are expected to tell the difference between 'GMODE', 'OMODE' and 'CMODE' in this pinout.](../Images/2f102ed49c7df2b1bcabb3c4f3c856ad.png)
...
尽管有这种蹩脚的语法，[Drew]还是想出了如何控制这个 LED 条。他最终用 LPC1768 Mbed 微控制器来驱动它，并用几个简单的动画制作了一个演示程序。你可以在下面看到一段视频。
 ...
 [https://www.youtube.com/embed/9ZWz8lr-Z2Q?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent](https://www.youtube.com/embed/9ZWz8lr-Z2Q?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent)T4】