...
> 原文：<https://hackaday.com/2015/08/11/getting-started-with-arm-using-mbed/>
...
[![mbed0](img/9805ae5d180a059b9ef9ac947b1871c6.png)](https://hackaday.com/wp-content/uploads/2015/08/mbed0.png) 一个 13 美元的开发板，有很多内存和其他好东西；听起来不错，对吧？但是开发工具肯定很贵或者很难安装，对吗？事实上，没有。ARM 提供了 mbed 网站，在您的浏览器中提供了完整的 C/C++ IDE(见左图)。根本不需要安装软件。版本控制、用户间共享库、文档。除了调试之外，你在 IDE 中想要的一切(但是不要忘记 Arduino IDE 也没有调试)。如果您喜欢使用本地工具链，则不必使用在线 IDE。然而，IDE 非常令人愉快，并且具有许多高效的特性。
