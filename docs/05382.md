...
> 原文:[https://hack aday . com/2014/02/26/3d-printering-making-a-thing-with-SolidWorks-part-ii/](https://hackaday.com/2014/02/26/3d-printering-making-a-thing-with-solidworks-part-ii/)

![printering1](../Images/82ec0bc6f1e4f07544bde609e6e87770.png)
...
![pt2-selectface](../Images/d2c50b194a541af104e72162c7813c72.png)

#### 素描

一条新的线将出现在模型树中(在本例中称为 Sketch2)。右键单击该图标，然后单击“垂直于”图标。这将旋转视图，使其垂直于草图所在的面。

![pt2-selectfacecol](../Images/fcf6925d318bfc6c96997b966b1195c2.png)
...
#### ![pt2-trimtool](../Images/fedc0b7cd338a295836a9b0464c06b18.png)
维度
...
![pt2-constraintstotal](../Images/61119fde6aedd13d274eae789d90d0e0.png)
...
![pt2-extrude](../Images/b92a8d3dc7fdcac1c997276c4f2f37d1.png)

#### 孔向导

为了制造孔和埋头孔，我们将尝试一些新的东西。从特征选项卡中选择孔向导。这个工具可以让我们同时钻孔和沉孔。在“孔规格”对话框中，选择下列选项:

![pt2-holespec](../Images/8b5ee8cfcf153f954db652505e1ef318.png)孔类型:遗留孔
类型:沉头孔(增加一个沉头孔)
结束条件:穿过所有(使孔穿过整个零件)
...
#### ![pt2-counterborehole](../Images/783223e83f027869d3c8838141479a55.png)
圆角
...
![pt2-3dfillet](../Images/baa72a827981058fdd59c0887bc86fb7.png)

就是这样！这是最终产品:

![pt2-final](../Images/83e5d05eeaa5e9ca0955a2bb6d20b16d.png)
这一列称为 3D 打印，为了打印零件，必须将文件保存在。stl 格式。这就像文件另存为一样简单。选择。文件类型列表中的 stl。

![DSC08408](../Images/6724aac92c70e14ab2133c955a7ab12f.png)
